...
use appchain_barnacle_runtime::{
	...
	StakingConfig, Balance, DOLLARS, BeefyConfig, DotMogModuleConfig, DotMogBaseConfig,
...
pub fn authority_keys_from_seed(s: &str) -> (AccountId, AccountId, BabeId, GrandpaId, ImOnlineId, BeefyId, OctopusId,
u64) {
	(
...
fn testnet_genesis(
	wasm_binary: &[u8],
	initial_authorities: Vec<(AccountId, AccountId, BabeId, GrandpaId, ImOnlineId, BeefyId, OctopusId, u64)>,
	...
	GenesisConfig {
		...
		pallet_dotmogbase: DotMogBaseConfig {
			key: root_key.clone(),
		},
